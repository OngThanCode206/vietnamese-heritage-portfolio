...
export const content: Record<Lang, Content> = {
    ...
    activities: [
      {
        ...
        role: "Sinh viên Tiêu biểu & Phong trào Rèn luyện",
        details: [
          "Tuyên dương danh hiệu “Sinh viên tiêu biểu trong học tập và rèn luyện năm học 2024 – 2025”.",
          "Tích cực tham gia các phong trào rèn luyện, hội nhập và học tập do Viện khởi xướng.",
        ],
      },
      {
        period: "2025",
        title: "Hoạt động Phong trào & Cuộc thi Công nghệ 2025",
        role: "Thành viên Ban Tổ chức & Thí sinh",
        details: [
          "Đạt Giải Ba cuộc thi “Rung Chuông Vàng – Tìm hiểu ASEAN” năm 2025.",
          "Đạt Giải Nhất Bóng đá Viện Công nghệ Việt – Hàn năm 2025.",
          "Giải Khuyến khích & Vòng Bán kết cuộc thi AIoT Innoworks 2025.",
          "Thành viên BTC Lễ hội Văn hóa Việt – Hàn năm 2025 (phối hợp cùng Học viện King Sejong Hồ Chí Minh 3).",
          "Tham gia Cuộc thi Ý tưởng Sáng tạo trẻ TP. Hồ Chí Minh lần thứ 17 (Chủ đề 'Bình Dân học vụ số').",
          "Tham gia Cuộc thi Chính luận về bảo vệ nền tảng tư tưởng của Đảng lần thứ Nhất năm 2025.",
          "Tham gia Talkshow “Sinh viên 5 tốt – Thời cơ và Thách thức” & Triển lãm Ngày hội Sinh viên 5 tốt.",
          "Tham gia hoạt động hội nhập “Trình diễn trang phục truyền thống các quốc gia”.",
          "Tham dự Lễ tuyên dương Thanh niên tiên tiến làm theo lời Bác 2025 & Lễ kết nạp Đảng.",
        ],
      },
      {
        period: "2026",
        title: "Viện Công nghệ Việt – Hàn, Đại học HUTECH",
        role: "Ban Tổ chức Sự kiện & Tình nguyện",
        details: [
          "Thành viên BTC chiến dịch Xuân tình nguyện 2026 tại Đắk Nông.",
          "Thành viên BTC chuỗi hoạt động Hành trình khám phá di sản do Viện Công nghệ Việt – Hàn tổ chức.",
        ],
      },
    ],
  ...
  en: {
    ...
    ui: {
      ...
      dark: "Dark mode",
      language: "Language",
      avatarCaption: " IT Student · HUTECH ",
      interestsTitle: "Personal Hobbies",
      hoangSa: "Hoang Sa",
      truongSa: "Truong Sa",
      footer: " IT Student at HUTECH",
    },
    sections: {
    ...
    activities: [
      {
        ...
        role: "Outstanding Student & Academic Movements",
        details: [
          "Honored as 'Outstanding Student in Academic & Training Performance 2024–2025'.",
          "Actively participated in academic and youth integration movements initiated by the Institute.",
        ],
      },
      {
        period: "2025",
        title: "Competitions & Event Organization 2025",
        role: "Organizing Committee & Contestant",
        details: [
          ...
          "Consolation Prize & Semi-finalist in AIoT Innoworks 2025.",
          "Organizing Committee member: Viet-Han Cultural Festival 2025 (co-organized with King Sejong Institute HCM 3).",
          "Team Lead contestant in the 17th HCMC Youth Creative Ideas Contest 2025.",
          "Contestant in HUTECH Political Essay Contest on Protecting Ideological Foundation 2025.",
          "Participated in 'Student of 5 Merits – Opportunities & Challenges' Talkshow & Exhibition.",
        ],
      },
      {
        period: "2026",
        title: "Viet-Han Institute of Technology, HUTECH University",
        role: "Event Organizing Committee & Volunteer",
        details: [
          "Organizing Committee member for Spring Volunteer Campaign 2026 in Dak Nong.",
          "Organizing Committee member for the Heritage Discovery Journey activity series.",
        ],
      },
    ],
  },
  ...
  kr: {
    ...
    ui: {
      ...
      dark: "다크 모드",
      language: "언어",
      avatarCaption: " IT 학생 · HUTECH ",
      interestsTitle: "개인 취미",
      hoangSa: "호앙사",
      truongSa: "쯔엉사",
      footer: " HUTECH IT 전공 학생",
    },
    sections: {
    ...
    activities: [
      {
        ...
        role: "우수 학생 및 학업 운동 참여자",
        details: [
          "2024-2025 학년도 학업 및 훈련 우수 학생 표창 수상.",
          "기술원에서 주관하는 학업 및 역량 강화 운동에 적극 참여.",
        ],
      },
      {
        period: "2025",
        title: "2025년 대외 활동 및 경진대회",
        role: "조직위원회 위원 및 대회 참가자",
        details: [
          "2025년 '아세안 알기' 골든벨 3등상 수상.",
          "2025년 한베기술원 축구 대회 우승.",
          "AIoT Innoworks 2025 장려상 및 본선 진출.",
          "2025년 한-베 문화 축제 조직위원회 위원 (세종학당 재단 협력).",
          "제17회 호치민시 청년 창의 아이디어 경진대회 참가.",
          "2025년 제1회 HUTECH 청년단 정치 논설 작성 대회 참가.",
          "2025년 '우수 학생 5' 토크쇼 및 전시회 참여.",
        ],
      },
      {
        period: "2026",
        title: "HUTECH 대학교 베트남-한국 기술원",
        role: "이벤트 조직위원회 및 자원봉사자",
        details: [
          "2026 닥농성 봄 자원봉사 캠페인 조직위원회 위원.",
          "문화유산 탐방 여정 활동 시리즈 조직위원회 위원.",
        ],
